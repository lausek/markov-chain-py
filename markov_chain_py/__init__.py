...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="amount of sentences to generate. This will overturn -n.",
    )
    parser.add_argument(
        "--lookback",
        type=int,
        default=1,
        help="amount of states to consider for determining the next state.",
    )
    parser.add_argument(
        "--keep-newlines",
        default=False,
        action="store_true",
        help="avoid stripping newline character from input data.",
    )
    parser.add_argument(
        "--verbose",
        default=False,
        action="store_true",
        help="output verbose information about the text generation.",
    )

    parser.add_argument(
        "--mode", type=str, default="", help="text generation mode: ngram, pos, tag"
    )
